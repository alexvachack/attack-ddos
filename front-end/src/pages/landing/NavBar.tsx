                    ...
                    <div className="auth-logo me-lg-5">
                        <Link to="/" className="logo logo-dark">
                            <span className="logo-lg">
                                <img src={logoDark} alt="" className="me-2" height="34" />
                            </span>
                        </Link>

                        <Link to="/" className="logo logo-light">
                            <span className="logo-lg">
                                <img src={logoLight} alt="" className="me-2" height="34" />
                            </span>
                        </Link>
                    </div>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav as="ul" className="ms-auto align-items-lg-center fs-16 fw-bold">
                            ...
                            <Nav.Item as="li" className="mx-lg-1">
                                {userLoggedIn || user ? (
                                    <Nav.Link as={Link} to="/auth/logout" className="link-demos tex-white">
                                        Cerrar Sesion
                                    </Nav.Link>
                                ) : (
                                    <Nav.Link as={Link} to="/auth/login" className="link-demos tex-white">
                                        Iniciar Sesion
                                    </Nav.Link>
                                )}
                            </Nav.Item>
